    ...
    return (
        <Headless.Field
            ...
            className={clsx(
                ...
                // Control layout
                "[&>[data-slot=control]]:col-start-1 [&>[data-slot=control]]:row-start-1 [&>[data-slot=control]]:justify-self-center [&>[data-slot=control]]:mt-0.5",
                // Label layout
...
const base = [
    // Basic layout
    "relative isolate flex size-[1.1875rem] shrink-0 rounded-full sm:size-[1.0625rem]", // size-4.75 -> 1.1875rem, size-4.25 -> 1.0625rem
