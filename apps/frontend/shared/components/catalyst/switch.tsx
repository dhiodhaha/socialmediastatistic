    ...
    return (
        <Headless.Field
            ...
            className={clsx(
                ...
                // Control layout
                "[&>[data-slot=control]]:col-start-2 [&>[data-slot=control]]:self-start [&>[data-slot=control]]:justify-self-end sm:[&>[data-slot=control]]:mt-0.5",
                // Label layout
    ...
    return (
        ...
        >
            <span
                ...
                className={clsx(
                    // Basic layout
                    "pointer-events-none relative inline-block size-[1.125rem] rounded-full sm:size-3.5", // size-4.5 -> 1.125rem
                    // Transition
