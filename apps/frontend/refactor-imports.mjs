...
const replacements = [
    ...
    {
        from: /@\/app\/actions\/account(?!\.actions)/g,
        to: "@/modules/accounts/actions/account.actions",
    },
    { from: /@\/components\/account-dialog/g, to: "@/modules/accounts/components/account-dialog" },
    {
        from: /@\/components\/failed-accounts-alert/g,
        to: "@/modules/accounts/components/failed-accounts-alert",
    },

    // Categories
    {
        from: /@\/actions\/category(?!\.actions)/g,
        to: "@/modules/categories/actions/category.actions",
    },
    {
        from: /@\/app\/actions\/category(?!\.actions)/g,
        to: "@/modules/categories/actions/category.actions",
    },
    {
        from: /@\/components\/category-dialog/g,
        to: "@/modules/categories/components/category-dialog",
    },

    // Scraping
    { from: /@\/actions\/scrape(?!\.actions)/g, to: "@/modules/scraping/actions/scrape.actions" },
    {
        from: /@\/app\/actions\/scrape(?!\.actions)/g,
        to: "@/modules/scraping/actions/scrape.actions",
    },
    ...
    {
        from: /@\/actions\/data-import(?!\.actions)/g,
        to: "@/modules/scraping/actions/data-import.actions",
    },
    {
        from: /@\/app\/actions\/data-import(?!\.actions)/g,
        to: "@/modules/scraping/actions/data-import.actions",
    },
    { from: /@\/components\/scrape-button/g, to: "@/modules/scraping/components/scrape-button" },
    {
        from: /@\/components\/scrape-progress/g,
        to: "@/modules/scraping/components/scrape-progress",
    },
    { from: /@\/components\/csv-upload/g, to: "@/modules/scraping/components/csv-upload" },
    {
        from: /@\/components\/data-import-upload/g,
        to: "@/modules/scraping/components/data-import-upload",
    },

    // Analytics
    {
        from: /@\/actions\/history(?!\.actions)/g,
        to: "@/modules/analytics/actions/history.actions",
    },
    {
        from: /@\/app\/actions\/history(?!\.actions)/g,
        to: "@/modules/analytics/actions/history.actions",
    },
    { from: /@\/actions\/report(?!\.actions)/g, to: "@/modules/analytics/actions/report.actions" },
    {
        from: /@\/app\/actions\/report(?!\.actions)/g,
        to: "@/modules/analytics/actions/report.actions",
    },
    { from: /@\/components\/reports\//g, to: "@/modules/analytics/components/reports/" },
    {
        from: /@\/components\/reports-selectors/g,
        to: "@/modules/analytics/components/reports-selectors",
    },
    { from: /@\/components\/stats-cards/g, to: "@/modules/analytics/components/stats-cards" },
    {
        from: /@\/components\/history-toolbar/g,
        to: "@/modules/analytics/components/history-toolbar",
    },
    {
        from: /@\/components\/recent-activity/g,
        to: "@/modules/analytics/components/recent-activity",
    },
    { from: /@\/components\/export-modal/g, to: "@/modules/analytics/components/export-modal" },

    // Settings
    {
        from: /@\/actions\/settings(?!\.actions)/g,
        to: "@/modules/settings/actions/settings.actions",
    },
    {
        from: /@\/app\/actions\/settings(?!\.actions)/g,
        to: "@/modules/settings/actions/settings.actions",
    },
